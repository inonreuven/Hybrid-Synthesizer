...
## Motivation
The synth consists two main parts; digital and analog, when this project focuses only on the digital part. The core of my Hybrid Musical Monophonic Synthesizer is the STM32F411RE Nucleo board.
